...
config :scope_research_and_development, ScopeResearchAndDevelopmentWeb.Endpoint,
  ...
  render_errors: [
    formats: [
      html: ScopeResearchAndDevelopmentWeb.ErrorHTML,
      json: ScopeResearchAndDevelopmentWeb.ErrorJSON
    ],
    layout: false
  ],
  pubsub_server: ScopeResearchAndDevelopment.PubSub,
  live_view: [signing_salt: "qvzDSveU"]
...
config :esbuild,
  version: "0.17.11",
  scope_research_and_development: [
    args:
