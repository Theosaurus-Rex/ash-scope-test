defmodule ScopeResearchAndDevelopmentWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ScopeResearchAndDevelopmentWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ScopeResearchAndDevelopmentWeb.Gettext, "errors", msg, opts)
    end
  end
