defmodule ScopeResearchAndDevelopment.Accounts do
  @moduledoc """
  ...
  alias ScopeResearchAndDevelopment.Accounts.{User, UserToken, UserNotifier}
  ...
  See `ScopeResearchAndDevelopment.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ScopeResearchAndDevelopment.Accounts.User.password_changeset/3` for a list of supported options.
